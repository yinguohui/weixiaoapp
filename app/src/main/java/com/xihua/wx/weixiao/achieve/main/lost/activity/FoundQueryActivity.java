...
public class FoundQueryActivity extends AppCompatActivity implements View.OnClickListener {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case 0:
                    break;
                case 1:
                    adapter = new LostInfoAdapter(list,FoundQueryActivity.this);
