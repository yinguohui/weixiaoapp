...
//适配器代码编写  最主要的就是逻辑的处理
public class DonationTimeAdapter extends RecyclerView.Adapter{

    private Context context;
    private List<DonationTimeLine> data;

    public DonationTimeAdapter(Context context, List<DonationTimeLine> list) {
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private DonationTimeLine timeData;
        ...
        public void setPosition(int position) {
            ...
            if (position == 0) {
                ...
                if (data.size() >= 2) {
                    if (!timeData.getDonationCreateTime().equals(data.get(position + 1).getDonationCreateTime())) {
                ...
                txtDateTime.setText(TimeFormat.format("yyyy-MM-dd hh:mm:ss", timeData.getDonationCreateTime()));
            ...
            txt_date_title.setText(timeData.getDonationName());
            rlTitle.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent intent = new Intent(context,DonationDetailActivity.class);
                    intent.putExtra("donation_id",timeData.getDonationId());
