...
//适配器代码编写  最主要的就是逻辑的处理
public class SuggestionTimeAdapter extends RecyclerView.Adapter{

    private Context context;
    private List<SuggestionTimeLine> data;

    public SuggestionTimeAdapter(Context context, List<SuggestionTimeLine> list) {
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private SuggestionTimeLine timeData;
        ...
        public void setPosition(int position) {
            ...
            if (position == 0) {
                ...
                if (data.size() >= 2) {
                    if (!timeData.getSuggestionCreateTime().equals(data.get(position + 1).getSuggestionCreateTime())) {
                ...
                txtDateTime.setText(TimeFormat.format("yyyy-MM-dd hh:mm:ss", timeData.getSuggestionCreateTime()));
            ...
            txt_date_title.setText(timeData.getSuggestionContent());
            rlTitle.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent intent = new Intent(context,MyInfoActivity.class);
                    intent.putExtra("suggestion_id",timeData.getSuggestionId());
